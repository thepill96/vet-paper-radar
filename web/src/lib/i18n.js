...
const en = {
  ...
  auth: { title: "Vet Stacks", blurb: "Read, annotate, and export the clinical literature that matters to you — collected every morning from PubMed. New accounts are reviewed by the administrator.",
    google: "Continue with Google", or: "or with email", email: "Email", password: "Password", signIn: "Sign in", signUp: "Create account", toSignUp: "New here? Sign up", toSignIn: "Have an account? Sign in",
...
const ko = {
  ...
  auth: { title: "Vet Stacks", blurb: "매일 아침 PubMed에서 모은 임상 논문을 읽고, 메모하고, 내보내는 곳. 새 계정은 운영자 승인을 거칩니다.",
    google: "Google로 계속하기", or: "또는 이메일로", email: "이메일", password: "비밀번호", signIn: "로그인", signUp: "가입하기", toSignUp: "처음이면 가입", toSignIn: "계정이 있으면 로그인",
...
const ja = {
  ...
  filter: { species: "対象", vet: "獣医", human: "医学", period: "収集期間", all: "すべて", days: "{n}日", state: "状態", unread: "未読", read: "既読", bookmarked: "ブックマーク", noted: "メモあり", ai: "AI要約", categories: "分野", journals: "ジャーナル", reset: "フィルター解除", selected: "{n}件選択", afterCollect: "初回収集後に表示" },
  ...
  auth: { title: "Vet Stacks", blurb: "毎朝PubMedから集めた臨床論文を読み、メモし、エクスポートする場所。新規アカウントは管理者が承認します。", google: "Googleで続行", or: "またはメールで", email: "メール", password: "パスワード", signIn: "ログイン", signUp: "アカウント作成", toSignUp: "初めての方は登録", toSignIn: "アカウントをお持ちの方", busy: "処理中…", signedUp: "登録完了。確認メールのリンクを開いてからログインしてください。管理者の承認後に論文を閲覧できます。", badCreds: "メールまたはパスワードが正しくありません。", notConfirmed: "メールがまだ確認されていません。" },
...
const de = {
  ...
  filter: { species: "Bereich", vet: "Veterinär", human: "Human", period: "Hinzugefügt in", all: "Gesamt", days: "{n} T.", state: "Status", unread: "Ungelesen", read: "Gelesen", bookmarked: "Lesezeichen", noted: "Mit Notiz", ai: "KI-Zusammenfassung", categories: "Fachgebiete", journals: "Journals", reset: "Filter zurücksetzen", selected: "{n} ausgewählt", afterCollect: "Erscheint nach der ersten Sammlung" },
...
const es = {
  ...
  filter: { species: "Ámbito", vet: "Veterinaria", human: "Humana", period: "Añadido en", all: "Todo", days: "{n} d", state: "Estado", unread: "Sin leer", read: "Leído", bookmarked: "Guardado", noted: "Con notas", ai: "Resumen IA", categories: "Campos", journals: "Revistas", reset: "Quitar filtros", selected: "{n} seleccionados", afterCollect: "Aparece tras la primera recolección" },
