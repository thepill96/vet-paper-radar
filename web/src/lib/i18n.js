...
const en = {
  ...
  admin: { notAllowed: "This section is for administrators only.", setupTitle: "Database setup incomplete", setupBody: "Run supabase/migration_008_admin.sql in the Supabase SQL Editor, then reload this page. Until then the sections below stay empty.", title: "Admin", lead: "Everything only administrators can see: approvals, member activity, announcements, feedback replies and summary costs.",
    papers: "Papers", papers7d: "Added this week", summarized: "Summarised", membersCount: "Members", pending: "Pending", comments: "Comments", feedbackNew: "New feedback", storage: "Storage used", protectedPapers: "Kept (bookmarked/read)", slimmed: "Abstract offloaded",
  ...
  reader: { hint: "Select a paper to read its summary and abstract.", read: "Read", unread: "Unread", markRead: "Mark as read", markUnread: "Mark unread",
    ...
    saved: "Saved", saving: "Saving…", noSummary: "No summary yet. Generating creates English and Korean versions.", noAbstract: "No abstract available on PubMed.", restoring: "Restoring the abstract from PubMed…",
  ...
  about: { title: "How it works", lead: "How papers are collected, filtered, classified, summarised and recommended — including every journal and keyword in use. This page is generated from the live configuration.",
    ...
    designHints: "Study-design hints", summarise: "Summaries", summariseManual: "Claude writes an English and a Korean summary, three clinical points, the study design and an evidence level, whatever the original language. Anatomical, procedural and implant terms stay in English. Summaries are not generated automatically — press \"Generate summary\" on a paper when you want one. The daily job only archives papers.", summariseHint: "Claude writes an English and a Korean summary, three clinical points, the study design and an evidence level, whatever the original language. Anatomical, procedural and implant terms stay in English. Up to {n} papers are summarised automatically per run; others on demand from the reader.",
...
const ko = {
  ...
  admin: { notAllowed: "관리자만 볼 수 있는 화면입니다.", setupTitle: "데이터베이스 설정이 끝나지 않았습니다", setupBody: "Supabase SQL Editor에서 supabase/migration_008_admin.sql 을 실행한 뒤 이 페이지를 새로고침하세요. 그 전까지 아래 항목은 비어 있습니다.", title: "관리자", lead: "관리자만 볼 수 있는 것들: 가입 승인, 회원 활동, 공지, 피드백 답장, 요약 비용.",
    papers: "논문", papers7d: "이번 주 추가", summarized: "요약 완료", membersCount: "회원", pending: "승인 대기", comments: "댓글", feedbackNew: "새 피드백", storage: "사용 용량", protectedPapers: "보호 논문", slimmed: "초록 비움",
  ...
  reader: { hint: "논문을 선택하면 요약과 초록이 표시됩니다.", read: "읽음", unread: "안 읽음", markRead: "읽음으로 표시", markUnread: "안 읽음으로",
    ...
    saved: "저장됨", saving: "저장 중…", noSummary: "아직 요약이 없습니다. 생성하면 한국어·영어가 함께 만들어집니다.", noAbstract: "PubMed에 초록이 없습니다.", restoring: "PubMed에서 초록을 다시 받아오는 중…",
  ...
  about: { title: "작동 방식", lead: "논문이 수집·필터·분류·요약·추천되는 방식과 사용 중인 저널·키워드 전체입니다. 이 페이지는 실제 설정 파일에서 생성됩니다.",
    ...
    designHints: "연구 설계 힌트", summarise: "요약", summariseManual: "원문 언어와 무관하게 Claude가 영어·한국어 요약, 임상 포인트 3개, 연구 설계, 근거 수준을 만듭니다. 해부학·술식·임플란트 용어는 영어를 유지합니다. 자동 요약은 하지 않으며 논문 화면의 \"AI 요약 생성\" 버튼을 눌렀을 때만 만들어집니다. 매일 아침 작업은 수집만 합니다.", summariseHint: "원문 언어와 무관하게 Claude가 영어·한국어 요약, 임상 포인트 3개, 연구 설계, 근거 수준을 만듭니다. 해부학·술식·임플란트 용어는 영어를 유지합니다. 실행당 최대 {n}편이 자동 요약되고 나머지는 상세 화면에서 필요할 때 만듭니다.",
