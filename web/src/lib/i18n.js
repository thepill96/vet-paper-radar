...
const en = {
  ...
  filter: { species: "Domain", vet: "Veterinary", human: "Human", period: "Added within", all: "All time", days: "{n}d", years: "{n}y",
...
const ko = {
  ...
  filter: { species: "대상", vet: "수의", human: "인의", period: "수집 기간", all: "전체", days: "{n}일", years: "{n}년",
...
const ja = {
  ...
  filter: { species: "対象", vet: "獣医", human: "医学", period: "収集期間", all: "すべて", days: "{n}日", years: "{n}年", state: "状態", unread: "未読", read: "既読", bookmarked: "ブックマーク", noted: "メモあり", ai: "AI要約", categories: "分野", journals: "ジャーナル", reset: "フィルター解除", selected: "{n}件選択", afterCollect: "初回収集後に表示" },
...
const es = {
  ...
  filter: { species: "Ámbito", vet: "Veterinaria", human: "Humana", period: "Añadido en", all: "Todo", days: "{n} d", years: "{n} a", state: "Estado", unread: "Sin leer", read: "Leído", bookmarked: "Guardado", noted: "Con notas", ai: "Resumen IA", categories: "Campos", journals: "Revistas", reset: "Quitar filtros", selected: "{n} seleccionados", afterCollect: "Aparece tras la primera recolección" },
